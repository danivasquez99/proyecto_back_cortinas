...
public class ServiceDAOImplement implements ServiceDAO {
    ...
    private static final String INSERT = "INSERT INTO service (name, category, description, estimatedCost, estimatedDuration, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE service SET name=?, category=?, description=?, estimatedCost=?, estimatedDuration=?, status=? WHERE idService=?";
